...
Alle Audio-Assets sind **CC0 (Public Domain)** — keine Attribution erforderlich,
hier dennoch dokumentiert (Quelle: opengameart.org, abgerufen 2026-07).
Nachbearbeitung (Schnitt, Fades, Normalisierung, MP3-Encode) im Projekt.

## Sound-Effekte (sounds/)
| Datei | Quelle | Autor |
|---|---|---|
| shoot.mp3 | "Cannon fire" | thimras |
| impact.mp3 | "Cannon hit wall" | thimras |
