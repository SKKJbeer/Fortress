...
ANTWORTEN = {
    ...
    # Ablehnungsgrund. Mild, weil das Ziel immer Mauerwerk ist, nie ein
    # Lebewesen. Entscheidung des Gruenders vom 16.09.
    #
    # Der Typ ist hier eine ZEICHENKETTE, bei `healthOrWellnessTopics`
    # dagegen ein Ja/Nein — beides von Apple selbst gemeldet. Die neuen
    # Schluessel von 2025 folgen also KEINER einheitlichen Regel; wer das
    # annimmt (wie ich einen Lauf lang), baut sich einen zweiten Fehlschlag.
